...
workspace_name = "Social_media_engagement" # PLACEHOLDER
subscription_id = "b70cd360-9bf7-4811-add7-49b8f59baf39" # PLACEHOLDER
resource_group = "MSHack" # PLACEHOLDER
experiment_name = "exp1" # PLACEHOLDER
iteration = "43"  # PLACEHOLDER
run_id = "AutoML_bf7840d2-5a31-488d-88df-bca241986748_43"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'compute_target':'model2','enable_dnn':False,'experiment_exit_score':None,'experiment_timeout_minutes':180,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':180,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'exp1','path':'./sample_projects/exp1','primary_metric':'spearman_correlation','region':'eastus2','resource_group':'MSHack','subscription_id':'b70cd360-9bf7-4811-add7-49b8f59baf39','task_type':'regression','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS3_V2','workspace_name':'Social_media_engagement','label_column_name':'Engagement','enable_run_restructure':True} # PLACEHOLDER
...
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"735171fe-bd62-4359-a327-e01da6009d7b\"}}" # PLACEHOLDER
